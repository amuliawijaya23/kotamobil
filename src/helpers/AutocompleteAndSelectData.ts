...
export const makesAndModels = {
  ...
  Wuling: ['Confero', 'Cortez', 'Almaz', 'Formo', 'Air EV', 'Victory'],
  DFSK: ['Glory 580', 'Glory i-Auto', 'Super Cab', 'Gelora', 'Glory 560'],
  BMW: [
    'Series 1',
    'Series 2',
    'Series 3',
  ...
  Lexus: ['UX', 'NX', 'RX', 'GX', 'LX', 'ES', 'LS', 'LC', 'RC'],
  Volkswagen: [
    'Polo',
    'Golf',
    'Tiguan',
  ...
  Peugeot: ['3008', '5008', '2008', '208', '308', '508'],
  Isuzu: ['Panther', 'D-Max', 'MU-X', 'Traga', 'Elf'],
  Subaru: ['Forester', 'XV', 'BRZ', 'Outback', 'WRX', 'Levorg'],
  Chevrolet: ['Trailblazer', 'Spark', 'Colorado', 'Captiva', 'Trax'],
  Jeep: ['Wrangler', 'Cherokee', 'Compass', 'Grand Cherokee', 'Renegade'],
  Tata: ['Xenon', 'Super Ace', 'Safari', 'Nexon', 'Harrier'],
  ...
  Renault: ['Kwid', 'Duster', 'Koleos', 'Triber', 'Captur'],
